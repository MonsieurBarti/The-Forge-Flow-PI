...
11. ${params.autonomyMode === "plan-to-pr" ? `Invoke the next phase command automatically: \`/tff:plan ${params.sliceLabel}\`.` : `Suggest the next step to the user: "Next: \`/tff:plan ${params.sliceLabel}\`."`}`;
}
