...
describe("GitStateBranchOpsAdapter integration", () => {
  it("createOrphan — new branch has no common ancestor with main", async () => {
  ...
  it("syncToStateBranch + readFromStateBranch — round-trip content is identical", async () => {
  ...
  it("readAllFromStateBranch — map contains all written files with correct content", async () => {
  ...
  it("forkBranch — modifying fork does not affect source", async () => {
  ...
  it("branchExists — true for existing branch, false for non-existing", async () => {
  ...
  it("renameBranch — old name gone, new name exists with same content", async () => {
  ...
  it("deleteBranch — branchExists returns false after deletion", async () => {
  ...
  it("readFromStateBranch with non-existing path — returns ok(null)", async () => {
