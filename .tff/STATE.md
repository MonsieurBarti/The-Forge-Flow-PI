...
|---|---|---|---|
| Checkpoint entity + repository | closed | 0/0 | 100% |
| Journal entity + replay | closed | 0/0 | 100% |
| Agent dispatch port + PI adapter | open | 0/0 | 0% |
| Worktree management | open | 0/0 | 0% |
